...
/**
 * The class describes the structure of the object Employee <- Person
 */

import qa_automation.appbody.enums.Qualification;
import qa_automation.appbody.interfaces.PersonTemplate;

public class Employee extends Person implements PersonTemplate {
    ...
    public Employee(String name, String city, String skills) {
        // Constructor
        this.name = name;
        this.city = city;
        this.skills = skills;
    ...
    public static void getInfo(Person person) {
        // Display info by person if it Employee
